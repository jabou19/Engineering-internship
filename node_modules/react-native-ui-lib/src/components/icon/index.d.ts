...
declare const _default: React.ComponentClass<Omit<ImageProps, "source"> & Partial<Record<"margin" | "marginL" | "marginT" | "marginR" | "marginB" | "marginH" | "marginV", boolean>> & RecorderProps & {
    /**
     * if provided icon source will be driven from asset name
     */
...
} & ThemeComponent, any> & React.ForwardRefExoticComponent<Omit<ImageProps, "source"> & Partial<Record<"margin" | "marginL" | "marginT" | "marginR" | "marginB" | "marginH" | "marginV", boolean>> & RecorderProps & {
    /**
     * if provided icon source will be driven from asset name
     */
    assetName?: string | undefined;
